...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" href="images/androidpng.png"/>
	...
	<body class="img js-fullheight" style="background-image: url(images/fn.jpg);">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					...
					<img src="images/androidpng.png" style="width:70%; height: 100%;">
				</div>
			</div>
			<div class="row justify-content-center">
